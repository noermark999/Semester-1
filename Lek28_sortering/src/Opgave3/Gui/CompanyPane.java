...
public class CompanyPane extends GridPane {
	...
	private final TextField txfFilterName = new TextField();
	private final ToggleGroup toggleGroup = new ToggleGroup();
	private final RadioButton[] radioButton = new RadioButton[Customer.SizeCategory.values().length];
	private final RadioButton rbAll = new RadioButton("ALL");
