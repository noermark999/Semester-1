...
public class test {
    public static void main(String[] args) {
        ...
        Kamp kamp2 = Controller.createKamp("Viborg", LocalDate.of(2021,10,11), LocalTime.of(10,30));
        Kamp kamp3 = Controller.createKamp("Harboøre", LocalDate.of(2021,10,12), LocalTime.of(10,30));
        Kamp kamp4 = Controller.createKamp("Herning", LocalDate.of(2021,10,13), LocalTime.of(10,30));
        Kamp kamp5 = Controller.createKamp("Thyborøn", LocalDate.of(2021,10,10), LocalTime.of(10,30));
